...
efficientnet_lite_params = {
    ...
    "effnet_lite0": [1.0, 1.0, 224, 0.2],
    "effnet_lite1": [1.0, 1.1, 240, 0.2],
    "effnet_lite2": [1.1, 1.2, 260, 0.3],
    "effnet_lite3": [1.2, 1.4, 280, 0.3],
    "effnet_lite4": [1.4, 1.8, 300, 0.3],
}

model_urls = {
    "effnet_lite0": "https://github.com/RangiLyu/EfficientNet-Lite/releases/download/v1.0/efficientnet_lite0.pth",  # noqa: E501
    "effnet_lite1": "https://github.com/RangiLyu/EfficientNet-Lite/releases/download/v1.0/efficientnet_lite1.pth",  # noqa: E501
    "effnet_lite2": "https://github.com/RangiLyu/EfficientNet-Lite/releases/download/v1.0/efficientnet_lite2.pth",  # noqa: E501
    "effnet_lite3": "https://github.com/RangiLyu/EfficientNet-Lite/releases/download/v1.0/efficientnet_lite3.pth",  # noqa: E501
    "effnet_lite4": "https://github.com/RangiLyu/EfficientNet-Lite/releases/download/v1.0/efficientnet_lite4.pth",  # noqa: E501
}
...
class EffNetLite(nn.Module):
    def __init__(
        ...
        super(EffNetLite, self).__init__()
